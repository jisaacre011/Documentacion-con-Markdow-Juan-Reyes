...
Sí, y hay razones sólidas para pensarlo. Markdown lleva más de 20 años siendo relevante en un industria donde las tecnologías cambian cada pocos años, lo que ya es una señal fuerte de su durabilidad.

Su fortaleza es estructural: al ser texto plano, no puede quedar obsoleto. Mientras existan computadoras que lean texto, Markdown funcionará. Las herramientas cambian —GitHub, Notion, Obsidian— pero el formato subyacente permanece.

Además, con el auge de la inteligencia artificial generativa, Markdown ha ganado nueva relevancia: los modelos de lenguaje lo usan naturalmente para estructurar sus respuestas, y muchas interfaces de IA lo renderizan directamente. Esto sugiere que Markdown no solo seguirá existiendo, sino que podría volverse aún más omnipresente en la forma en que los humanos y las IAs intercambian información estructurada.